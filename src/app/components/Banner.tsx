  ...
  return (
    <section className="relative h-[80vh] min-h-[500px] flex items-center justify-center sm:h-screen">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-5 text-center">
        ...
        <p className="text-base text-indigo-50 mb-6 mx-auto max-w-md sm:text-lg sm:max-w-xl sm:mb-7 md:text-xl md:max-w-2xl md:mb-8 animate-fade-in-up-second">
        ...
        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
          <div className="flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full sm:px-5 sm:py-2.5 md:px-6 md:py-3 animate-fade-in-up-third">
            <span className="text-white text-lg mr-2">🌍</span>
            <span className="text-white font-medium text-sm sm:text-base">
              FR | EN | ES | RU
            </span>
          </div>
          <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 text-sm rounded-full transition-all duration-300 transform hover:scale-105 sm:px-7 sm:py-3 sm:text-base animate-fade-in-up-third">
            View Portfolio
          </button>
        </div>
      </div>
